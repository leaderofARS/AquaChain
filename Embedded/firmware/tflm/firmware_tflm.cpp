...
// Eloquent TFLM runtime configuration
#define N_INPUTS 5
#define N_OUTPUTS 1
...
void setup() {
  ...
  // Configure TFLM ops and IO dims
...
void loop() {
  ...
  // Calibration tuned to observed ADC (~3830-3890 dry on your board)
  const int AIR_VALUE = 3900;   // dry (higher ADC)
  const int WATER_VALUE = 1600; // wet (lower ADC)
